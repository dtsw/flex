...
[ExcludeClass]
public class _FlexGrocer_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _FlexGrocer_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "FlexGrocer" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "collections", "components", "core", "effects", "layout", "logging", "messaging", "rpc", "skins", "sparkEffects", "styles", "textLayout" ],
            creationComplete: "handleCreationComplete(event)",
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "FlexGrocer",
            mixins: [ "_FlexGrocer_FlexInit", "_FlexGrocer_Styles", "mx.messaging.config.LoaderConfig" ],
            placeholderRsls: [
